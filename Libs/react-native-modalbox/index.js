...
var ModalBox = createReactClass({
  ...
  componentWillMount: function () {
    ...
    // if (Platform.OS === 'ios') {
    const keyboardEvent = Platform.OS === 'ios' ? 'keyboardWillChangeFrame' : 'keyboardDidShow'
    this.subscriptions = [
      // Keyboard.addListener('keyboardWillChangeFrame', this.onKeyboardChange),
      Keyboard.addListener(keyboardEvent, this.onKeyboardChange),
  ...
  onKeyboardHide: function (evt) {
    ...
    if (Platform.OS === 'android' && this.state.isOpen) {
      this.animateOpen()
    }
  },
